...
public interface RequestTaskCustomRepository {
	...
	// 검색 기능을 포함한 요청 과제 조회
	Page<Object[]> findRequestTaskListWithSaveCount(RequestTaskType requestTaskType, String keyword,
	...
	Page<Object[]> findPopularRequestTaskListWithSaveCount(RequestTaskType requestTaskType, Pageable pageable);
}
