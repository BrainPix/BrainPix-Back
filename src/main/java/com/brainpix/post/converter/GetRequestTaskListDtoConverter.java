...
public class GetRequestTaskListDtoConverter {
	...
	public static GetRequestTaskListDto.Response toResponse(Page<Object[]> requestTasks) {

		List<GetRequestTaskListDto.requestTaskDetail> requestTaskDetailList = requestTasks.stream()
			.map(requestTask -> {
		...
		return GetRequestTaskListDto.Response.builder()
